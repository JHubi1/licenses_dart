...
Map<String, dynamic> content = {
  ...
  "standardLicenseTemplate":
      "<<var;name=\"copyright\";original=\"Copyright 1999-2011, Donald Arseneau, asnd@triumf.ca, Vancouver, Canada\";match=\".{0,5000}\">>\n\nThis software may be freely used, transmitted, reproduced, or modified provided that the copyright notice and this permission is retained.\n\n",
  "name": "magaz License",
  "licenseComments":
      "This license is a very similar to ulem and fwlw, but has slightly different obligations.",
  "licenseId": "magaz",
  "crossRef": [
    {
      "match": "false",
